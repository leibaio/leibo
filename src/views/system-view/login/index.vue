 ...
 * @LastEditTime: 2022-06-26 10:42:49
 * @FilePath: /leibo/src/views/system-view/login/index.vue
 * @Description: 登录组件修改
-->
<template>
      ...
      <div class="w-300px sm:w-360px">
        <header class="flex-y-center justify-between">
          ...
          <!-- <div class="w-70px h-70px overflow-hidden"> -->
            <!-- 系统 logo -->
            <system-logo class="text-70px w-70px h-70px text-primary" :fill="false" />
          </div>
          <n-gradient-text type="info" :size="28">{{ title }}</n-gradient-text>
        </header>
        <main class="pt-24px">
